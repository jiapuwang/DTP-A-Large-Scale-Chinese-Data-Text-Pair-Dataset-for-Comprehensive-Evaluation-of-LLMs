...
def main():
    ...
    configure_logging('/public/chengweiwu/mingyang/logs/1115/combined_tasks_Humanities_and_Society_glm-4-9b.log')
    ...
    tasks = [
        {'input_file': '/public/chengweiwu/mingyang/data/input_data/submit/textGen_submit/textGen_all_Humanities_and_Society_random_1w1_head1w_dev2k.jsonl',
         'output_file': '/public/chengweiwu/mingyang/data/output_data/1115/text_gen_output_Humanities_and_Society_glm-4-9b.jsonl',
