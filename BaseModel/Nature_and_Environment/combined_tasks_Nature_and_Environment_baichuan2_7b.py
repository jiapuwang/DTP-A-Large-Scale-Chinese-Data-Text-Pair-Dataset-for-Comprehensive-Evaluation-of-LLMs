...
def main():
    ...
    configure_logging('/public/chengweiwu/mingyang/logs/1115/combined_tasks_Nature_and_Environment_baichuan2_7b.log')
    ...
    tasks = [
        {'input_file': '/public/chengweiwu/mingyang/data/input_data/submit/qa_submit/qa_all_Nature_and_Environment_random_1w1_head1w_dev2k.jsonl',
         'output_file': '/public/chengweiwu/mingyang/data/output_data/1115/qa_output_Nature_and_Environment_baichuan2_7b.jsonl',
