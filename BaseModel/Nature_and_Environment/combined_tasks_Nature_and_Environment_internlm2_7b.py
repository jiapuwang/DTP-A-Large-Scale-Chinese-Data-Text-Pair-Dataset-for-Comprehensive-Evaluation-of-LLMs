...
def process_task(input_file_path, output_file_path, model_path, query_template):
    ...
    with open(input_file_path, 'r', encoding='utf-8') as infile, open(output_file_path, 'w', encoding='utf-8') as outfile:
        for line in infile:
            ...
            gen_kwargs = {"max_length": 2500, "top_p": 0.8, "temperature": 0.8, "do_sample": True, "repetition_penalty": 1.0}
            with torch.no_grad():
...
def main():
    model_path = "/public/chengweiwu/models/cdtp/internlm2-7b"
    configure_logging('/public/chengweiwu/mingyang/logs/1112/combined_tasks_Nature_and_Environment_internlm2_7b.log')

    # tokenizer, model, device = load_model(model_path)

    tasks = [
        {
            'input_file': '/public/chengweiwu/mingyang/data/input_data/submit/qa_submit/qa_all_Nature_and_Environment_random_1w1_head1w_dev2k.jsonl',
            'output_file': '/public/chengweiwu/mingyang/data/output_data/1112/qa_output_Nature_and_Environment_internlm2_7b.jsonl',
            'template': qa_template},
        {
            ...
            'output_file': '/public/chengweiwu/mingyang/data/output_data/1112/text_gen_output_Nature_and_Environment_internlm2_7b.jsonl',
            'template': text_gen_template},
        {
            ...
            'output_file': '/public/chengweiwu/mingyang/data/output_data/1112/kg_output_Nature_and_Environment_internlm2_7b.jsonl',
        ...
        for task in tasks:
            results.append(
                pool.apply_async(process_task,
                                 (task['input_file'], task['output_file'], model_path, task['template'])))
