...
def process_task(input_file_path, output_file_path, pipeline, query_template):
...
def main():
    model_path = "/public/chengweiwu/models/cdtp/Meta-Llama-3-8B"
    configure_logging('/public/chengweiwu/mingyang/logs/1112/combined_tasks_Nature_and_Environment_llama_3_8b.log')
    ...
    tasks = [
        {'input_file': '/public/chengweiwu/mingyang/data/input_data/submit/qa_submit/qa_all_Nature_and_Environment_random_1w1_head1w_dev2k.jsonl',
         'output_file': '/public/chengweiwu/mingyang/data/output_data/1112/qa_output_Nature_and_Environment_llama_3_8b.jsonl',
        ...
        {'input_file': '/public/chengweiwu/mingyang/data/input_data/submit/textGen_submit/textGen_all_Nature_and_Environment_random_1w1_head1w_dev2k.jsonl',
         'output_file': '/public/chengweiwu/mingyang/data/output_data/1112/text_gen_output_Nature_and_Environment_llama_3_8b.jsonl',
        ...
        {'input_file': '/public/chengweiwu/mingyang/data/input_data/submit/kg_submit/kg_all_Nature_and_Environment_random1w1_head1w_dev2k.jsonl',
         'output_file': '/public/chengweiwu/mingyang/data/output_data/1112/kg_output_Nature_and_Environment_llama_3_8b.jsonl',
        ...
        for task in tasks:
            results.append(
                pool.apply_async(process_task,
                                 (task['input_file'], task['output_file'], pipeline, task['template'])))
