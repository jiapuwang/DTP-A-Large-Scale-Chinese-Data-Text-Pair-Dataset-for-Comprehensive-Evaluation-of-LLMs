...
def main():
    ...
    configure_logging('/public/chengweiwu/mingyang/logs/1115/combined_tasks_Nature_and_Environment_phi_2.log')
    ...
    tasks = [
        {'input_file': '/public/chengweiwu/mingyang/data/input_data/submit/textGen_submit/textGen_all_Nature_and_Environment_random_1w1_head1w_dev2k.jsonl',
         'output_file': '/public/chengweiwu/mingyang/data/output_data/1115/text_gen_output_Nature_and_Environment_phi_2.jsonl',
        ...
        {'input_file': '/public/chengweiwu/mingyang/data/input_data/submit/kg_submit/kg_all_Nature_and_Environment_random1w1_head1w_dev2k.jsonl',
         'output_file': '/public/chengweiwu/mingyang/data/output_data/1115/kg_output_Nature_and_Environment_phi_2.jsonl',
