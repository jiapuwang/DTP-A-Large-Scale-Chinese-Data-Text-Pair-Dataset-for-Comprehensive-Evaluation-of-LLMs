...
# 配置日志记录器
logging.basicConfig(
    filename='/public/chengweiwu/mingyang/logs/1117/kg_History_and_Politics_phi_2.log',
    level=logging.INFO,
...
ckpt = torch.load('/public/chengweiwu/mingyang/sft/checkpoints/phi-2_kg_History_and_Politics/epoch-2-333-hf/pytorch_model.bin')
...
output_file_path = '/public/chengweiwu/mingyang/data/output_data/1117/kg_output_History_and_Politics_phi_2.jsonl'
