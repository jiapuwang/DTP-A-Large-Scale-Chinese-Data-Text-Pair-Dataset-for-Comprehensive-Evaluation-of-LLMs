...
logging.basicConfig(
    filename='/public/chengweiwu/mingyang/logs/1117/text_gen_History_and_Politics_glm-4-9b.log',
    level=logging.INFO,
...
ckpt = torch.load('/public/chengweiwu/mingyang/sft/checkpoints/glm-4-9b_text_gen_History_and_Politics/epoch-2-339-hf/pytorch_model.bin')
...
# todo:3需要改输入/输出文件
# 打开JSONL文件
with open('/public/chengweiwu/mingyang/data/input_data/submit/textGen_submit/textGen_all_History_and_Politics_random_1w1_head1w_dev2k.jsonl', 'r',
          encoding='utf-8') as input_file, \
        open('/public/chengweiwu/mingyang/data/output_data/1117/text_gen_output_History_and_Politics_glm-4-9b.jsonl',
             'w',
