...
# 配置日志记录器
logging.basicConfig(
    filename='/public/chengweiwu/mingyang/logs/1120/text_gen_History_and_Politics_phi_2.log',
    level=logging.INFO,
...
output_file_path = '/public/chengweiwu/mingyang/data/output_data/1120/text_gen_output_History_and_Politics_phi_2.jsonl'
