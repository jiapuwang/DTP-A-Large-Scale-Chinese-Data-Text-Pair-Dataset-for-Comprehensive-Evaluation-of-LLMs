...
logging.basicConfig(
    filename='/public/chengweiwu/mingyang/logs/1117/qa_Humanities_and_Society_glm-4-9b.log',
    level=logging.INFO,
    format='%(asctime)s - %(levelname)s - %(message)s')

# todo:2需要改 cuda卡
os.environ['CUDA_VISIBLE_DEVICES'] = "2"  # 设置 GPU 编号，如果单机单卡指定一个，单机多卡指定多个 GPU 编号
# todo:5 model_path
...
ckpt = torch.load('/public/chengweiwu/mingyang/sft/checkpoints1119/glm-4-9b_qa_Humanities_and_Society/pytorch_model.bin')
...
# todo:3需要改输入/输出文件
# 打开JSONL文件
with open('/public/chengweiwu/mingyang/data/input_data/submit/qa_submit/qa_all_Humanities_and_Society_random_1w1_head1w_dev2k.jsonl', 'r',
          encoding='utf-8') as input_file, \
        open('/public/chengweiwu/mingyang/data/output_data/1117/qa_output_Humanities_and_Society_glm-4-9b.jsonl',
             'w',
