...
# 配置日志记录器
logging.basicConfig(
    filename='/public/chengweiwu/mingyang/logs/1117/text_gen_Humanities_and_Society_internlm2_7b.log',
    level=logging.INFO,
...
# 新模型路径
MODEL_NAME = "/public/chengweiwu/models/cdtp/internlm2-7b"
...
ckpt = torch.load('/public/chengweiwu/mingyang/sft/checkpoints/internlm2-7b_text_gen_Humanities_and_Society/epoch-2-339-hf/pytorch_model.bin')
...
# 输入/输出文件配置
input_file_path = '/public/chengweiwu/mingyang/data/input_data/submit/textGen_submit/textGen_all_Humanities_and_Society_random_1w1_head1w_dev2k.jsonl'
output_file_path = '/public/chengweiwu/mingyang/data/output_data/1117/text_gen_output_Humanities_and_Society_internlm2_7b.jsonl'
