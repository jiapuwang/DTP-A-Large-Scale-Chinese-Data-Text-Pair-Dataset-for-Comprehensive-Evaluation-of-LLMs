...
logging.basicConfig(
    filename='/public/chengweiwu/mingyang/logs/1117/kg_Technology_and_Economics_glm-4-9b.log',
    level=logging.INFO,
...
ckpt = torch.load('/public/chengweiwu/mingyang/sft/checkpoints/glm-4-9b_Technology_and_Economics/epoch-2-333-hf/pytorch_model.bin')
...
# todo:3需要改输入/输出文件
# 打开JSONL文件
with (open('/public/chengweiwu/mingyang/data/input_data/submit/kg_submit/kg_all_Technology_and_Economics_random1w1_head1w_dev2k.jsonl', 'r',
          encoding='utf-8') as input_file, \
        open('/public/chengweiwu/mingyang/data/output_data/1117/kg_output_Technology_and_Economics_glm-4-9b.jsonl',
             'w',
