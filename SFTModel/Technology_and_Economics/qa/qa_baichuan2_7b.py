...
# 配置日志记录器
logging.basicConfig(
    filename='/public/chengweiwu/mingyang/logs/1117/qa_Technology_and_Economics_baichuan2_7b.log',
    level=logging.INFO,
    format='%(asctime)s - %(levelname)s - %(message)s'
)

os.environ['CUDA_VISIBLE_DEVICES'] = "3"
MODEL_NAME = "/public/chengweiwu/models/cdtp/Baichuan2-7B-Base"
device = "cuda" if torch.cuda.is_available() else "cpu"

tokenizer = AutoTokenizer.from_pretrained(MODEL_NAME, use_fast=False, trust_remote_code=True)
model = AutoModelForCausalLM.from_pretrained(MODEL_NAME, device_map="auto", trust_remote_code=True)

ckpt = torch.load('/public/chengweiwu/mingyang/sft/checkpoints/Baichuan2-7B-Base_qa_Technology_and_Economics/epoch-2-261-hf/pytorch_model.bin')
...
output_file_path = '/public/chengweiwu/mingyang/data/output_data/1117/qa_output_Technology_and_Economics_baichuan2_7b.jsonl'
