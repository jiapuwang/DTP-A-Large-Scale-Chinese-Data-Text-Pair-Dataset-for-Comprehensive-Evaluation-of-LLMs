...
# 配置日志记录器
logging.basicConfig(
    filename='/public/chengweiwu/mingyang/logs/1117/qa_Technology_and_Economics_internlm2_7b.log',
    level=logging.INFO,
...
ckpt = torch.load('/public/chengweiwu/mingyang/sft/checkpoints/internlm2-7b_qa_Technology_and_Economics/epoch-2-261-hf/pytorch_model.bin')
...
# 输入/输出文件配置
input_file_path = '/public/chengweiwu/mingyang/data/input_data/submit/qa_submit/qa_all_Technology_and_Economics_random_1w1_head1w_dev2k.jsonl'
output_file_path = '/public/chengweiwu/mingyang/data/output_data/1117/qa_output_Technology_and_Economics_internlm2_7b.jsonl'
