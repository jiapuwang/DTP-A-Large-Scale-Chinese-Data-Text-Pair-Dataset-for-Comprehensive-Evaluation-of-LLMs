...
# 配置日志记录器
logging.basicConfig(
    filename='/public/chengweiwu/mingyang/logs/1120/text_gen_Technology_and_Economics_phi_2.log',
    level=logging.INFO,
...
output_file_path = '/public/chengweiwu/mingyang/data/output_data/1120/text_gen_output_Technology_and_Economics_phi_2.jsonl'
