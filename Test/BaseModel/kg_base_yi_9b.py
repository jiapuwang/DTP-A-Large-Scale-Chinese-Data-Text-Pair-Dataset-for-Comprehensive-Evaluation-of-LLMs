...
# 配置日志记录器
logging.basicConfig(
    filename='/public/chengweiwu/mingyang/logs/1124/kg_base_yi_9b.log',
    level=logging.INFO,
...
# 输入/输出文件配置
input_file_path = '/public/chengweiwu/mingyang/data/input_data/1124/kg_1124_cleaned.jsonl'
output_file_path = '/public/chengweiwu/mingyang/data/output_data/1124/kg_output_base_yi_9b.jsonl'
