...
# 配置日志记录器
logging.basicConfig(
    filename='/public/chengweiwu/mingyang/logs/1124/kg_sft_yi_9b.log',
    level=logging.INFO,
...
output_file_path = '/public/chengweiwu/mingyang/data/output_data/1124/kg_output_sft_yi_9b.jsonl'
