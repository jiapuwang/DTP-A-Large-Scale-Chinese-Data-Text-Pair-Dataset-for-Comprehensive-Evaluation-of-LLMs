...
# 配置日志记录器
logging.basicConfig(
    filename='/public/chengweiwu/mingyang/logs/1124/qa_sft_yi_9b.log',
    level=logging.INFO,
...
ckpt = torch.load('/public/chengweiwu/mingyang/sft/checkpoints/Yi-9B_qa_History_and_Politics/epoch-2-252-hf/pytorch_model.bin')
...
# 输入/输出文件配置
input_file_path = '/public/chengweiwu/mingyang/data/input_data/1124/qa_1024_output.jsonl'
output_file_path = '/public/chengweiwu/mingyang/data/output_data/1124/qa_output_sft_yi_9b.jsonl'
