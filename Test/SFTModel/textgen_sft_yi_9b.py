...
# 配置日志记录器
logging.basicConfig(
    filename='/public/chengweiwu/mingyang/logs/1124/text_gen_sft_yi_9b.log',
    level=logging.INFO,
...
ckpt = torch.load('/public/chengweiwu/mingyang/sft/checkpoints/Yi-9B_text_gen_History_and_Politics/epoch-2-339-hf/pytorch_model.bin')
...
# 输入/输出文件配置
input_file_path = '/public/chengweiwu/mingyang/data/input_data/1124/text_gen_1124.jsonl'
output_file_path = '/public/chengweiwu/mingyang/data/output_data/1124/text_gen_output_sft_yi_9b.jsonl'
...
with open(input_file_path, 'r', encoding='utf-8') as input_file, \
    ...
    for line in input_file:
        ...
        query = ((
                     ...
                     "以下是一些需要生成目标文本的实例，要求用一句英文回答，只需给出生成的目标文本，无需做任何解释，生成的目标文本以<SOD>开始<EOD>结束。"
